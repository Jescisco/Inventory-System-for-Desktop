...
class MainView():
    ...
    def main(self):
        ...
        store_button=CTkButton(container, text='Almacen', height=50, width= 150, command=self.store_view)
    ...
    def store_view(self):
        from Views.StoreView import StoreView
        self.clean_window()
        store_view=StoreView(self.app)
        store_view.store(self.main)
